...
- Individual Codelabs
   ...
   - [~~Background Work with WorkManager - Kotlin~~](https://developer.android.com/codelabs/android-workmanager#0)
...
- [Android Architecture: Part 1 – Every New Beginning is Hard](https://five.agency/android-architecture-part-1-every-new-beginning-is-hard/)
   - Tomislav Homan
   - 7 comments
...
<img src="https://developer.android.com/topic/libraries/architecture/images/final-architecture.png" width="800" height="600" />
...
- [Desenvolvimento Android: Arquitectura MVP (Kotlin)](https://www.udemy.com/course/curso-de-desenvolvimento-andorid-padrao-de-arquitectura-mvp/)
- [MVP on Android](https://www.raywenderlich.com/9216-mvp-on-android)
- [MVVM on Android](https://www.raywenderlich.com/8984-mvvm-on-android)
...
- [Using Kotlin to implement Clean Architecture by Lieven Doclo](https://www.youtube.com/watch?v=0wAvVcrbVK4)
   ...
   - 11.648 views
   - 114 likes
- [Clean Architecture no Android por Ubiratan Soares - Devfest São Paulo 2016](https://www.youtube.com/watch?v=4dUKiggwHPM)
   - GDG São Paulo
   - 2.138 views
   - 108 likes
...
- [Architecture Component + Kotlin + MVVM + Koin (Part 1 - Intro)](https://www.youtube.com/watch?v=kdn8uGCgGds)
   - Pedro Massango
   - 2.846 views
   - 14 likes
- [Architecture Component + Kotlin + MVVM + Koin (Part 2 - The ViewModel)](https://www.youtube.com/watch?v=kP55JzKxjaM)
   - Pedro Massango
   - 2.281 views
   - 10 likes
- [#1 Android MVVM Architecture Tutorial - Introduction](https://www.youtube.com/watch?v=67bdklHmXA8&list=PLk7v1Z2rk4hjVaZ8DZKe8iT9RIM9OUrwp)
   - Simplified Coding
   - 20 videos
...
- [1 - Kotlin Android Tutorial - Overview and Topics | MVP, ViewModel, Clean Architecture, SoC](https://www.youtube.com/watch?v=Na4n7b78_hs)
   - wiseAss
   - 6.237 views
   - 256 likes
